<div class="space-y-4">
    <div class="overflow-hidden shadow sm:rounded-md">
        <div class="flex-col px-4 py-5 space-y-4 bg-white border-white dark:bg-gray-800 dark:border-gray-700 sm:p-6">
            ...
            <x-hub::input.group :label="__('adminhub::inputs.default.label')"
                ...
                <x-hub::input.toggle wire:model="channel.default"
                                     :disabled="$channel->id && $channel->getOriginal('default')"
                                     value="1" />
            </x-hub::input.group>
        </div>

        <div class="px-4 py-3 text-right bg-black/5 dark:bg-white/5 sm:px-6">
            <button type="submit"
    ...
    @if ($channel->id && !$channel->getOriginal('default') && !$channel->wasRecentlyCreated)
        <div class="overflow-hidden bg-white border border-red-300 rounded shadow dark:bg-gray-800 dark:border-red-700">
            <header class="px-6 py-4 text-red-700 border-b border-red-300 dark:border-red-700 bg-red-500/5">
                <strong>
                ...
                <div class="grid grid-cols-12 gap-4">
                    <div class="col-span-12 md:col-span-6">
                        <strong class="text-gray-900 dark:text-white">
                            {{ __('adminhub::partials.forms.channel.delete_channel') }}
                        </strong>

                        <p class="text-xs text-gray-600 dark:text-gray-300">
                            {{ __('adminhub::partials.forms.channel.channel_name_delete') }}
                        </p>
                    </div>
